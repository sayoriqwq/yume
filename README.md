...
实际上这个项目还在开发中，很多功能还没有完善。但代码基本都在本地，然后说实话写的也不咋地，想重构的时候发现已经完全没办法维护了qwq

由于一开始的定位就是练手，在这个项目里塞了太多想练习的东西，导致项目结构和代码质量都不太好。一开始甚至有很多分支，然后也重构过几次，整各种乱七八糟的东西

还是应该在设计阶段就想好项目的定位和结构，实现的蓝图
