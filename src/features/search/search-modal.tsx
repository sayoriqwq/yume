...
import { isComposingAtom, meiliSearchModalAtom, useSearchHotkeys } from '@/features/search/atoms/use-search-hotkey'
      ...
      <CommandList>
        ...
        {(((hits?.length === 0 || !hits) && !isLoading && !error)) && (
          <CommandEmpty className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <span className="i-mingcute-inbox-2-fill size-8" />
          </CommandEmpty>
        )}
